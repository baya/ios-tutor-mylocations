...
//  MyLocations
//
//  Created by jiangguimin on 14-6-12.
...
{
    MKCoordinateRegion region = [self regionForAnnotaions:_locations];
    
    [self.mapView setRegion:region animated:YES];
}

- (MKCoordinateRegion)regionForAnnotaions:(NSArray *)annotations
{
